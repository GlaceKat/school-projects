...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    player_score = 0;
    if num_rolls == 0:
        firstDigit = (opponent_score // 10) % 10
        secondDigit = opponent_score % 10
        return 1 + max(firstDigit, secondDigit)
    else:
...
def is_swap(score0, score1):
    ...
    if score0 >= GOAL_SCORE:
        score01 = (score0 // 10) % 10
        score11 = score1 // 10;

    elif score1 >= GOAL_SCORE:

        score01 = score0 //10
        score11 = (score1 // 10) % 10

    else:
        score01 = score0 // 10;
        score11 = score1 // 10;
    
    if score01 == score12 and score02 == score11:
        return True
    else:
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
          score0 += take_turn(strategy0(score0, score1), score1, dice = select_dice(score0, score1))
        else:
          score1 += take_turn(strategy1(score0, score1), score0, dice = select_dice(score0, score1))
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for num_rolls in range(1, 11):
        score = average_roll(num_rolls, dice)
        if score > maxScore:
            maxScore = score
            maxDice = num_rolls
    return maxDice
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    firstDigit = (opponent_score // 10) % 10
    secondDigit = opponent_score % 10
    if 1 + max(firstDigit, secondDigit) >= margin:
        return 0
    return num_rolls
    # END Question 8
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    firstDigit = (opponent_score // 10) % 10
    secondDigit = opponent_score % 10
    newScore = score + 1 + max(firstDigit, secondDigit)
...
def final_strategy(score, opponent_score):
    ...
    This strategy works the same as swap_strategy, but it also rolls 0 dice if
    if it will not be a harmful swap and it will force the opponent to roll 4 dice
    """
    # BEGIN Question 10
    ...
    if is_swap(newScore, opponent_score):
        return num_rolls
    if (newScore + opponent_score) % 7 == 0:
        return 0
